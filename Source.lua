...
if gethui then
	for _, Interface in ipairs(gethui():GetChildren()) do
		if Interface.Name == Library.Name and Interface ~= Library then
			Interface:Destroy()
		end
	end
else
...
function UILib:IsRunning()
	if gethui then
		...
		return Library.Parent == game:GetService("CoreGui")
	end
...
function UILib:MakeWindow(WindowConfig)
	...
	WindowConfig.Name = WindowConfig.Name or "m_gnet"
	...
	WindowConfig.IntroText = WindowConfig.IntroText or "m_gnet was here"
